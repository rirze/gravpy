...
pmodelargs2 = [alpha(1, 0, 0, 0.1, 0, 0.0, 0.99)]
...
# If we want an image with runtime stats, set bool to true, otherwise runs
# the statement in the else branch.
callgraph = False
# where we want to save the output image with the runtime breakdown
filepath = 'runs/filename.png'
config = Config()
